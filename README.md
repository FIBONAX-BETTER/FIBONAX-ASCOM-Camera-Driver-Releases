...
`FIBONAX_ASCOM_Camera_Driver_Setup_v1.0.0.zip`

Do not download `Source code (zip)` or `Source code (tar.gz)`. These files are automatically generated by GitHub and are not the driver installer.
